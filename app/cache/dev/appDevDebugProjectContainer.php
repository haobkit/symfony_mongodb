...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'D:/xampp/htdocs/symfony_project/symfony_mongodb/app/cache/dev/annotations', true);
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('D:/xampp/htdocs/symfony_project/symfony_mongodb/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'StudyBlogBundle', 'D:/xampp/htdocs/symfony_project/symfony_mongodb/app/Resources/StudyBlogBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'StudyBlogBundle', 'D:\\xampp\\htdocs\\symfony_project\\symfony_mongodb\\src\\Study\\BlogBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FOSUserBundle', 'D:/xampp/htdocs/symfony_project/symfony_mongodb/app/Resources/FOSUserBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FOSUserBundle', 'D:\\xampp\\htdocs\\symfony_project\\symfony_mongodb\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, '', 'D:/xampp/htdocs/symfony_project/symfony_mongodb/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    {
        $this->services['assetic.filter.yui_css'] = $instance = new \Assetic\Filter\Yui\CssCompressorFilter('D:/xampp/htdocs/symfony_project/symfony_mongodb/app/Resources/java/yuicompressor.jar', 'C:\\Program Files\\Java\\jre7\\bin\\java.EXE');
    ...
    {
        $this->services['assetic.filter.yui_js'] = $instance = new \Assetic\Filter\Yui\JsCompressorFilter('D:/xampp/htdocs/symfony_project/symfony_mongodb/app/Resources/java/yuicompressor.jar', 'C:\\Program Files\\Java\\jre7\\bin\\java.EXE');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'D:/xampp/htdocs/symfony_project/symfony_mongodb/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_b441dcf017a6f163b8e3f3f2e622ad1d');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_b441dcf017a6f163b8e3f3f2e622ad1d');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_b441dcf017a6f163b8e3f3f2e622ad1d');

        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array('D:\\xampp\\htdocs\\symfony_project\\symfony_mongodb\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\doctrine' => 'FOS\\UserBundle\\Entity'));
        ...
        $f->setProxyDir('D:/xampp/htdocs/symfony_project/symfony_mongodb/app/cache/dev/doctrine/orm/Proxies');
    ...
    protected function getDoctrineMongodb_Odm_DefaultConfigurationService()
    {
        ...
        $instance->setHydratorDir('D:/xampp/htdocs/symfony_project/symfony_mongodb/app/cache/dev/doctrine/odm/mongodb/Hydrators');
        $instance->setHydratorNamespace('Hydrators');
        $instance->setAutoGenerateHydratorClasses(false);
        $instance->setDefaultDB('symfony_mongodb');
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addSubscriberService('study_blog_user.password_resetting', 'Study\\BlogBundle\\EventListener\\PasswordResettingListener');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'D:/xampp/htdocs/symfony_project/symfony_mongodb/app/Resources');
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Study\\BlogBundle\\Document\\Member');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\TwigSwiftMailer($this->get('mailer'), $this->get('router'), $this->get('twig'), array('template' => array('confirmation' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting' => 'StudyBlogBundle:Email:resetting.email.html.twig'), 'from_email' => array('confirmation' => array('webmaster@example.com' => 'webmaster'), 'resetting' => array('info@demo.com' => 'Admin Demo Page'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Study\\BlogBundle\\Document\\Member');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Study\\BlogBundle\\Document\\Member');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Study\\BlogBundle\\Document\\Member');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine_mongodb')->getManager(NULL), 'Study\\BlogBundle\\Document\\Member');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('D:/xampp/htdocs/symfony_project/symfony_mongodb/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:D:/xampp/htdocs/symfony_project/symfony_mongodb/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'D:/xampp/htdocs/symfony_project/symfony_mongodb/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'D:/xampp/htdocs/symfony_project/symfony_mongodb/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Study\\BlogBundle\\Document\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000)), 'FOS\\UserBundle\\Model\\UserInterface' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('D:/xampp/htdocs/symfony_project/symfony_mongodb/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('D:/xampp/htdocs/symfony_project/symfony_mongodb/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('D:/xampp/htdocs/symfony_project/symfony_mongodb/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/xampp/htdocs/symfony_project/symfony_mongodb/app/cache/dev/sessions');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return Study\BlogBundle\EventListener\PasswordResettingListener A Study\BlogBundle\EventListener\PasswordResettingListener instance.
     */
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'D:/xampp/htdocs/symfony_project/symfony_mongodb/app', 'UTF-8');
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'D:/xampp/htdocs/symfony_project/symfony_mongodb/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'D:/xampp/htdocs/symfony_project/symfony_mongodb/app', 'UTF-8'));
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'StudyBlogBundle', 1 => 'FOSUserBundle'), $this->get('assetic.value_supplier.default', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('D:\\xampp\\htdocs\\symfony_project\\symfony_mongodb\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('D:\\xampp\\htdocs\\symfony_project\\symfony_mongodb\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('D:\\xampp\\htdocs\\symfony_project\\symfony_mongodb\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('D:\\xampp\\htdocs\\symfony_project\\symfony_mongodb\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('D:\\xampp\\htdocs\\symfony_project\\symfony_mongodb\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('D:\\xampp\\htdocs\\symfony_project\\symfony_mongodb\\vendor\\doctrine\\mongodb-odm-bundle\\Doctrine\\Bundle\\MongoDBBundle/Resources/views', 'DoctrineMongoDB');
        ...
        $instance->addPath('D:/xampp/htdocs/symfony_project/symfony_mongodb/app/Resources/views');
        $instance->addPath('D:\\xampp\\htdocs\\symfony_project\\symfony_mongodb\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/xampp/htdocs/symfony_project/symfony_mongodb/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('D:/xampp/htdocs/symfony_project/symfony_mongodb/app/cache/dev/assetic/assets');
    }
    ...
    /**
     * Gets the 'security.user.provider.concrete.my_mongo_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    {
        return $this->services['security.user.provider.concrete.my_mongo_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine_mongodb'), 'Study\\BlogBundle\\Document\\User', 'username', NULL);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/xampp/htdocs/symfony_project/symfony_mongodb/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'D:\\xampp\\htdocs\\symfony_project\\symfony_mongodb\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml', 1 => 'D:\\xampp\\htdocs\\symfony_project\\symfony_mongodb\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation.xml', 2 => 'D:\\xampp\\htdocs\\symfony_project\\symfony_mongodb\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation\\mongodb.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array(0 => 'D:\\xampp\\htdocs\\symfony_project\\symfony_mongodb\\src\\Study\\BlogBundle\\Resources\\config\\validation.yml')))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'D:/xampp/htdocs/symfony_project/symfony_mongodb/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'D:/xampp/htdocs/symfony_project/symfony_mongodb/app/cache/dev',
            'kernel.logs_dir' => 'D:/xampp/htdocs/symfony_project/symfony_mongodb/app/logs',
            ...
            'debug.container.dump' => 'D:/xampp/htdocs/symfony_project/symfony_mongodb/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'D:/xampp/htdocs/symfony_project/symfony_mongodb/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'D:\\xampp\\htdocs\\symfony_project\\symfony_mongodb\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
                1 => 'D:\\xampp\\htdocs\\symfony_project\\symfony_mongodb\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation.xml',
                2 => 'D:\\xampp\\htdocs\\symfony_project\\symfony_mongodb\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation\\mongodb.xml',
            ),
            'validator.mapping.loader.yaml_files_loader.mapping_files' => array(
                0 => 'D:\\xampp\\htdocs\\symfony_project\\symfony_mongodb\\src\\Study\\BlogBundle\\Resources\\config\\validation.yml',
            ),
            ...
            'profiler.storage.dsn' => 'file:D:/xampp/htdocs/symfony_project/symfony_mongodb/app/cache/dev/profiler',
            ...
            'router.resource' => 'D:/xampp/htdocs/symfony_project/symfony_mongodb/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/xampp/htdocs/symfony_project/symfony_mongodb/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'assetic.cache_dir' => 'D:/xampp/htdocs/symfony_project/symfony_mongodb/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'D:/xampp/htdocs/symfony_project/symfony_mongodb/app/../web',
            'assetic.write_to' => 'D:/xampp/htdocs/symfony_project/symfony_mongodb/app/../web',
            ...
            'assetic.filter.yui_css.jar' => 'D:/xampp/htdocs/symfony_project/symfony_mongodb/app/Resources/java/yuicompressor.jar',
            ...
            'assetic.filter.yui_js.jar' => 'D:/xampp/htdocs/symfony_project/symfony_mongodb/app/Resources/java/yuicompressor.jar',
            ...
            'doctrine.orm.proxy_dir' => 'D:/xampp/htdocs/symfony_project/symfony_mongodb/app/cache/dev/doctrine/orm/Proxies',
            ...
            'doctrine_mongodb.odm.proxy_dir' => 'D:/xampp/htdocs/symfony_project/symfony_mongodb/app/cache/dev/doctrine/odm/mongodb/Proxies',
            'doctrine_mongodb.odm.auto_generate_proxy_classes' => false,
            'doctrine_mongodb.odm.hydrator_namespace' => 'Hydrators',
            'doctrine_mongodb.odm.hydrator_dir' => 'D:/xampp/htdocs/symfony_project/symfony_mongodb/app/cache/dev/doctrine/odm/mongodb/Hydrators',
            ...
            'fos_user.resetting.email.template' => 'StudyBlogBundle:Email:resetting.email.html.twig',
            'fos_user.registration.confirmation.template' => 'FOSUserBundle:Registration:email.txt.twig',
            'fos_user.storage' => 'mongodb',
            'fos_user.firewall_name' => 'main',
            'fos_user.model_manager_name' => NULL,
            'fos_user.model.user.class' => 'Study\\BlogBundle\\Document\\Member',
