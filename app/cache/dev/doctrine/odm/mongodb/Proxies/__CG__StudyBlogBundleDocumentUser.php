 ...
 */
class User extends \Study\BlogBundle\Document\User implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'username', 'salt', 'password', 'email', 'isActive', 'role');
    }
